...
?>
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Advocates available (<?php echo $list11->num_rows; ?>)</p>
                    </td>
                    
                </tr>
                <?php
                    
                    // Update the SQL query to retrieve only verified advocates
                    if ($_POST) {
                        $keyword = $_POST["search"];
                        $sqlmain = "SELECT * FROM advocate WHERE (advemail='$keyword' OR advname='$keyword' OR advname LIKE '$keyword%' OR advname LIKE '%$keyword' OR advname LIKE '%$keyword%') AND verified = 1";
                    } else {
                        $sqlmain = "SELECT * FROM advocate WHERE verified = 1 ORDER BY advid DESC";
                    }
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a class="close" href="advocate.php">&times;</a>
                            <div class="content">
                            ...
                            <a href="advocate.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
